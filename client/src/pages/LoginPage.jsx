      ...
      <div className="min-h-screen bg-surface-0 mesh-bg flex items-center justify-center px-4">
        <div className="w-full max-w-md space-y-6">
          <div className="text-center space-y-3">
            <div className="w-14 h-14 bg-brand-600/20 rounded-2xl mx-auto animate-pulse" />
            <div className="h-8 w-48 bg-surface-200 rounded-xl mx-auto animate-pulse" />
            <div className="h-5 w-64 bg-surface-200 rounded-lg mx-auto animate-pulse" />
          </div>
            ...
            <div className="mb-5 p-3.5 rounded-xl bg-danger/5 border border-danger/20 flex items-start gap-3">
              ...
              <div>
                ...
                {error.includes('register') && (
                  <Link to="/register" className="text-brand-400 text-sm hover:underline mt-1 inline-block">Create an account</Link>
                )}
              </div>
            </div>
          )}
