...
import { Video, Plus, LogOut, Clock, Users, ChevronRight, Shield, Menu, X, Settings, User } from 'lucide-react';
                ...
                <div className="py-1">
                  ...
                  {isAdmin && (
                    <Link
                      to="/admin"
                      onClick={() => setMenuOpen(false)}
                      className="flex items-center gap-3 px-4 py-2.5 text-sm text-yellow-400 hover:bg-gray-700 hover:text-yellow-300 transition-colors"
                    >
        ...
        <div className="flex gap-4 mb-8 border-b border-gray-700 pb-4">
          <button
            ...
            className={`px-6 py-2 rounded-lg font-semibold transition-all ${
              activeTab === 'home' ? 'bg-zoom-blue text-white' : 'text-gray-400 hover:text-white'
            }`}
          >
            Home
          </button>
          <button
            ...
            className={`px-6 py-2 rounded-lg font-semibold transition-all ${
              activeTab === 'meetings' ? 'bg-zoom-blue text-white' : 'text-gray-400 hover:text-white'
            }`}
          >
            My Meetings
          </button>
          ...
          <div className="space-y-8">
            {loading ? (
              <div className="text-center py-12">
                <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-zoom-blue mx-auto"></div>
              </div>
            ) : (
              <>
                <div>
